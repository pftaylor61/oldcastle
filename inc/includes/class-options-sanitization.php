...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => esc_html__( 'No Repeat', 'oldcastle' ),
		'repeat-x'  => esc_html__( 'Repeat Horizontally', 'oldcastle' ),
		'repeat-y'  => esc_html__( 'Repeat Vertically', 'oldcastle' ),
		'repeat'    => esc_html__( 'Repeat All', 'oldcastle' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_html__( 'Top Left', 'oldcastle' ),
		'top center'    => esc_html__( 'Top Center', 'oldcastle' ),
		'top right'     => esc_html__( 'Top Right', 'oldcastle' ),
		'center left'   => esc_html__( 'Middle Left', 'oldcastle' ),
		'center center' => esc_html__( 'Middle Center', 'oldcastle' ),
		'center right'  => esc_html__( 'Middle Right', 'oldcastle' ),
		'bottom left'   => esc_html__( 'Bottom Left', 'oldcastle' ),
		'bottom center' => esc_html__( 'Bottom Center', 'oldcastle' ),
		'bottom right'  => esc_html__( 'Bottom Right', 'oldcastle')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_html__( 'Scroll Normally', 'oldcastle' ),
		'fixed'  => esc_html__( 'Fixed in Place', 'oldcastle')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => esc_html__( 'Normal', 'oldcastle' ),
		'italic'      => esc_html__( 'Italic', 'oldcastle' ),
		'bold'        => esc_html__( 'Bold', 'oldcastle' ),
		'bold italic' => esc_html__( 'Bold Italic', 'oldcastle' )
		);
